...
<div class="navbar-wrapper">
 ...
 <div id="wrapper3">
  <h1 align="center">ADD NEW RESOURCES</h1>
  	<form method="POST" action="doCreateResource">
  <table id="keywords" cellspacing="0" cellpadding="0">
   

		
		   <h4 align="center" ><b><font color="red">${errorString7}</font></b></h4>
			<tr>
				<td>Resource Name</td>
				<td><input type="text" name="pptname" required="required" /></td>
			</tr>
			<tr>
				<td>Subject</td>
			...
			<tr>
				<td>Resource Link</td>
				<td><input type="text" name="pptlink" required="required" /></td>
			</tr>
			<tr>
